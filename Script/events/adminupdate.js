        ...
        switch (logMessageType) {
            case "log:thread-admins": {
                if (logMessageData.ADMIN_EVENT == "add_admin") {
                    ...
                    if (global.configModule[this.config.name].sendNoti) api.sendMessage(`»» NOTICE «« Update user ${logMessageData.TARGET_ID} বলদ দেখ তোরে নেহা আপু কত ভালোবাসে এডমিন করে দিছে😁🫵🏾`, threadID, async (error, info) => {
